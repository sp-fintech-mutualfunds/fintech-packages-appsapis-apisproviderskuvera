<?php
/**
 * GetFundSchemeDetails200ResponseInnerNav
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetFundSchemeDetails200ResponseInnerNav Class Doc Comment
 *
 * @category Class
 * @package  Apps\Fintech\Packages\Apis\Providers\Kuvera
 * @author   OpenAPI Generator team
 ...
 */
class GetFundSchemeDetails200ResponseInnerNav implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_fund_scheme_details_200_response_inner_nav';
    ...
    */
    ...
    public function setDate($date)
    {
        ...
        if ((mb_strlen($date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $date when calling GetFundSchemeDetails200ResponseInnerNav., must be bigger than or equal to 1.');
        }
