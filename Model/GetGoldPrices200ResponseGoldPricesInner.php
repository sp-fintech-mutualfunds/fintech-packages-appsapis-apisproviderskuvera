<?php
/**
 * GetGoldPrices200ResponseGoldPricesInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetGoldPrices200ResponseGoldPricesInner Class Doc Comment
 *
 * @category Class
 * @package  Apps\Fintech\Packages\Apis\Providers\Kuvera
 * @author   OpenAPI Generator team
 ...
 */
class GetGoldPrices200ResponseGoldPricesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_gold_prices_200_response_gold_prices_inner';
    ...
    */
    ...
    public function setDate($date)
    {
        ...
        if ((mb_strlen($date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $date when calling GetGoldPrices200ResponseGoldPricesInner., must be bigger than or equal to 1.');
        }
